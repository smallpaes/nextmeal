...
const { validOrderForm, validComment, validMessage } = require('../middleware/middleware.js')
const orderController = require('../controllers/orderController.js')
const multer = require('multer')
const upload = multer({ dest: 'temp/' })

router.get('/new', orderController.getNew) //瀏覽新增一筆訂購餐點的表單
router.post('/new', validOrderForm, validMessage, orderController.postNew)
...
router.put('/:order_id', validOrderForm, validMessage, orderController.putOrder)
